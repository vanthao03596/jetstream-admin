<div class="relative z-10 flex-shrink-0 flex h-16 bg-white border-b border-gray-200">
    <button type="button" class="px-4 border-r border-gray-200 text-gray-500 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-gray-900 lg:hidden" @click="$parent.open = true">
                    ...
                    <x-slot name="content">
                        <div class="px-2">
                            ...
                            <div class="text-center text-gray-500 underline text-xs py-2">
                                <a href="#">{{ __('Go to Notifications') }}</a>
                            </div>
                        </div>
                    </x-slot>
                </x-jet-dropdown>
